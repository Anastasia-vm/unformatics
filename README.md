...
<html>
 <head>
  <meta charset="utf-8" />
  <title>Сайт-звіт до лабораторних робіт студентки 1 курсу групи "Фізики" Слободяник Анастасії Вадимівни</title>
  <style type="text/css">
   body {
...
6.2. Рідний формат для редактору Libre (Open) Office.
 <p>6.2 <a href="lab1.odt">Формат Open Office (*.odt)</a></p>
   ...
   <div class="clear"></div>
   <div id="footer">&copy; Сайт-звіт до лабораторних робіт студентки 1 курсу групи "Фізики" Слободяник Анастасії Вадимівни</div>
  </div>
 </body>
</html>
